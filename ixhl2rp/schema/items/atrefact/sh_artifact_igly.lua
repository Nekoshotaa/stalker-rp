...
ITEM.name = "Иглы"
ITEM.description = "Колючий гравитационный артефакт. Увеличивает подвижность и заметно смягчает падения."
ITEM.longdesc = "Хорош для лазания по развалинам и резких манёвров. Не любит неосторожных владельцев и слегка фонит."
ITEM.model = "models/wick/anarchycell/items/artefacts/soc/anarchycell_needles1.mdl"
ITEM.price = 8200
ITEM.fallResist = 0.28
ITEM.runSpeedMultBonus = 0.06
ITEM.jumpVelocityBonus = 26
ITEM.artifactRadiation = 0.14
