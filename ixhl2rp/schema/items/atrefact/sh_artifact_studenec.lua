...
ITEM.name = "Студенец"
ITEM.description = "Вязкий химический артефакт. Смягчает кислотные ожоги и немного стягивает раны, но слегка фонит."
ITEM.longdesc = "Хороший выбор для вылазок в едкие аномалии. Не лучший источник силы, зато заметно повышает живучесть."
ITEM.model = "models/wick/wrbstalker/shoc/items/artefacts/wick_artefact_ameba1.mdl"
ITEM.price = 4700
ITEM.healthRegen = 1
ITEM.bleedResist = 0.15
ITEM.artifactRadiation = 0.1
