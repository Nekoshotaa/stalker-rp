...
ITEM.name = "Глаз"
ITEM.description = "Горячий артефакт каплевидной формы. Помогает организму восстанавливаться, но заметно накапливает радиацию."
ITEM.longdesc = "Хорош для выживания после стычек, особенно если рядом есть способы быстро сбросить накопленную радиацию."
ITEM.model = "models/wick/anarchycell/items/artefacts/builds/anarchycell_glaz.mdl"
ITEM.price = 7800
ITEM.burnResist = 0.3
ITEM.healthRegen = 0.4
ITEM.artifactRadiation = 0.2
