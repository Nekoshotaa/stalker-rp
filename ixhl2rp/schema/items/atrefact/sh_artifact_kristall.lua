...
ITEM.name = "Кристалл"
ITEM.description = "Чистый красный артефакт. Понемногу очищает организм от радиации и почти не имеет побочного фона."
ITEM.longdesc = "Без ПСИ-эффектов. Это безопасная адаптация под твою сборку."
ITEM.model = "models/wick/anarchycell/items/artefacts/cop/anarchycell_cristall.mdl"
ITEM.price = 5400
ITEM.radRegen = 0.6
ITEM.burnResist = 0.1
