...
ITEM.name = "Батарейка"
ITEM.description = "Электрический артефакт. Ускоряет движения и слегка смягчает электрические разряды, но понемногу фонит."
ITEM.longdesc = "Полезна для вылазок в электры и при быстром перемещении, но долго носить её без защиты не стоит."
ITEM.model = "models/kek1ch/dummy_battery.mdl"
ITEM.price = 6200
ITEM.shockResist = 0.35
ITEM.runSpeedMultBonus = 0.05
ITEM.artifactRadiation = 0.15
