...
ITEM.description = "Сильный термический артефакт. Даёт серьёзную защиту от огня и чуть ускоряет восстановление, но сильно фонит."
ITEM.longdesc = "Мощный, но капризный артефакт — без антирада быстро станет проблемой."
ITEM.model = "models/wick/anarchycell/items/artefacts/cop/anarchycell_fire.mdl"
ITEM.price = 9700
ITEM.burnResist = 0.65
ITEM.healthRegen = 0.15
