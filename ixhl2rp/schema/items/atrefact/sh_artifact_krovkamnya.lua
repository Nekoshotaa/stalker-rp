...
ITEM.description = "Плотный красноватый артефакт. Улучшает выносливость тела и помогает переживать рваные раны, но фонит."
ITEM.longdesc = "Неплохой выбор для ближнего боя и вылазок против мутантов."
ITEM.model = "models/wick/anarchycell/items/artefacts/cop/anarchycell_blood.mdl"
ITEM.price = 6900
ITEM.healthRegen = 0.25
ITEM.bleedResist = 0.3
ITEM.artifactRadiation = 0.25
