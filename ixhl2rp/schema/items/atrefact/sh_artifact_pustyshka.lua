...
ITEM.name = "Пустышка"
ITEM.description = "Тяжёлый деформирующий артефакт. Смягчает падения и немного держит удар, но заметно фонит."
ITEM.longdesc = "Подходит тем, кто часто лезет в опасные места и ловит лишние удары."
ITEM.model = "models/wick/anarchycell/items/artefacts/builds/anarchycell_pustishka.mdl"
ITEM.price = 9100
ITEM.bulletResist = 0.12
ITEM.fallResist = 0.25
ITEM.artifactRadiation = 0.35
