ITEM.name = "Рагу «Сытый Охотник»"
ITEM.description = "Тяжёлое мясное рагу из кабана и плоти. Густая, сытная еда для тех, кто привык таскать на себе лишний вес и долго держаться на ногах."
ITEM.model = "models/props/stalcraft/kotelokfood11.mdl"
ITEM.uniqueID = "food_ragu_sytyy_okhotnik"
ITEM.category = "Еда"
...
function ITEM:GetDescription()
    ...
    desc = desc .. "\nДаёт постоянный бонус: +1 к Силе и +1 к Выносливости"
    return desc
end

function ITEM:PopulateTooltipIndividual(tooltip)
    ix.util.PropertyDesc(tooltip, "Особая еда", Color(205, 170, 125))
    ix.util.PropertyDesc(tooltip, "+1 Сила", Color(120, 200, 120))
    ix.util.PropertyDesc(tooltip, "+1 Выносливость", Color(120, 200, 120))
end
...
ITEM.functions.Use = {
    ...
    OnRun = function(item)
        ...
        if #changes > 0 then
            client:Notify("Вы чувствуете прилив сил: " .. table.concat(changes, ", ") .. ".")
        end
