ITEM.name = 'Фляга с пивом'
ITEM.description = 'Металлическая фляга, наполненная пивом. Странный выбор, но в Зоне никого этим не удивишь.'
ITEM.model = 'models/kek1ch/drink_water.mdl'

ITEM.uniqueID = 'drink_beer_flask'
ITEM.price = 350
ITEM.width = 1
ITEM.height = 2
ITEM.hunger = 0
