ITEM.name = 'Пиво <Три кобольда>'
ITEM.description = 'Дешёвое пиво с грубым вкусом. Холодным было бы лучше, но и так сойдёт.'
ITEM.model = 'models/kek1ch/drink_beer.mdl'

ITEM.uniqueID = 'drink_beer_threekobolds'
ITEM.price = 380
ITEM.width = 1
ITEM.height = 2
ITEM.hunger = 0
...
ITEM.functions.Use = {
    ...
    OnRun = function(item)
        ...
        if client.AddBuff then client:AddBuff("buff_radiationremoval", 10, { amount = 0.05 }) end
