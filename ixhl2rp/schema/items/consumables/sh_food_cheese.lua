ITEM.name = 'Сыр'
ITEM.description = 'Небольшой кусок сыра. Питательно и удобно брать в короткие вылазки.'
ITEM.model = 'models/wick/wrbstalker/cop/newmodels/items/wick_cheese.mdl'
