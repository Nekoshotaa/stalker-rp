ITEM.name = "Взлом: тихие замки"
ITEM.description = "Небольшой блокнот с рисунками личинок, навесных замков и самодельных отмычек из проволоки. Половина текста написана настолько мелко, будто автор боялся, что записи прочтёт не тот человек. При прочтении повышает навык «Взлом» на +1."
...
ITEM.attributeCandidates = {"lockpicking", "hck", "Взлом"}
