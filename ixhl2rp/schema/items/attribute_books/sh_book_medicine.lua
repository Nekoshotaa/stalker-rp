ITEM.name = "Медицина: перевязать и дожить"
ITEM.description = "Полевой медицинский конспект с пятнами йода и схемами наложения жгута. На полях — правки от неизвестного медика, явно привыкшего лечить не в кабинете, а под обстрелом. При прочтении повышает навык «Медицина» на +1."
...
ITEM.attributeCandidates = {"medicine", "med", "Медицина"}
