ITEM.name = "Особое умение: нестандартный подход"
ITEM.description = "Неровно сшитая папка с разными заметками: от психологических приёмов до странных тренировок внимания. Её трудно назвать учебником, но полезные мысли там точно есть. При прочтении повышает навык «Особое умение» на +1."
...
ITEM.attributeCandidates = {"osoboe", "rol", "Особое умение"}
