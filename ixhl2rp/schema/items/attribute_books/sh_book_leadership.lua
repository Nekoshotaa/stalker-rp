ITEM.name = "Лидерство: держать отряд"
ITEM.description = "Сборник заметок о том, как вести людей через страх, усталость и плохие новости. Автор часто повторяет: «командир отвечает первым, а отдыхает последним». При прочтении повышает навык «Лидерство» на +1."
...
ITEM.attributeCandidates = {"leadership", "ldr", "Лидерство"}
