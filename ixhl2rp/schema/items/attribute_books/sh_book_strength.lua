ITEM.name = "Сила: рюкзак и лом"
ITEM.description = "Грубая тетрадь с упражнениями, которые можно делать с ящиком патронов, канистрой или просто тяжёлым камнем. Полезно, если жизнь часто требует тащить больше, чем хочется. При прочтении повышает навык «Сила» на +1."
...
ITEM.attributeCandidates = {"strength", "str", "Сила"}
