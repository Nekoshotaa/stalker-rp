ITEM.name = "Обман: говорить не всё"
ITEM.description = "Мятая брошюра с примерами полуправды, легенд и способов уходить от прямого ответа. Кто-то зачеркнул половину советов и подписал: «слишком честно». При прочтении повышает навык «Обман» на +1."
...
ITEM.attributeCandidates = {"deception", "dec", "Обман"}
