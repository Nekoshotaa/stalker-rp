ITEM.name = "Авторитет: голос старшего"
ITEM.description = "Тонкая книжка без автора, больше похожая на сборник лагерных правил и сталкерских баек. Между строками — как говорить так, чтобы тебя не перебили, и как держать лицо, когда вокруг пахнет порохом. При прочтении повышает навык «Авторитет» на +1."
...
ITEM.attributeCandidates = {"authority", "aut", "Авторитет"}
