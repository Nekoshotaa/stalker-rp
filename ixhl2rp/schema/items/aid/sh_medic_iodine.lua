ITEM.name = "Йод"
ITEM.description = "Пузырёк с йодом. Используется для обработки ран и как вспомогательное средство после облучения."
...
function ITEM:PopulateTooltipIndividual(tooltip)
    ix.util.PropertyDesc(tooltip, "Обработка ран", Color(120, 220, 120))
end
