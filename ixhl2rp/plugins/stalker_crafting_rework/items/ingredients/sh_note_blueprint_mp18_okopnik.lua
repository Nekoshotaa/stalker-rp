ITEM.name = "Записка: MP18 «Окопник»"
ITEM.description = "Старая оружейная записка с заметками по восстановлению MP18. Бумага пахнет маслом, пылью и чужой мастерской."
ITEM.model = "models/akabenko/item_notens.mdl"
ITEM.uniqueID = "note_blueprint_mp18_okopnik"
...
ITEM.recipeID = "blueprint_mp18_okopnik"
ITEM.recipeName = "MP18 «Окопник»"
