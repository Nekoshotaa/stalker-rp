ITEM.name = "9x19 мм FMJ (ST)"
ITEM.description = "Коробка патронов 9x19 FMJ для ST-оружия. Подходит для ПП «Гепард» и другого оружия с тем же ammo type."
ITEM.base = "base_ammo"
ITEM.model = "models/wick/wrbstalker/anomaly/items/wick_ammo_9x19_pbp_old.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.category = "Ammo"
ITEM.ammoType = "st_ammo_9x19_fmj"
ITEM.ammoAmount = 44
ITEM.ammoBoxText = "Патроны 9x19 для ST-пака."
