ITEM.name = "20x70 мм"
ITEM.description = "Коробка дробовых патронов 20x70. Подходит для обреза ТОЗ-106 и МЦ 20-01."
ITEM.base = "base_ammo"
ITEM.model = "models/wick/wrbstalker/anomaly/items/wick_ammo_12x76_zhekan.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.category = "Ammo"
ITEM.ammoType = "st_ammo_20x70"
ITEM.ammoAmount = 16
ITEM.ammoBoxText = "Патроны 20 калибра для лёгких охотничьих ружей."
