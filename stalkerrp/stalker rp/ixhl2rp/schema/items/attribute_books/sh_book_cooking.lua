ITEM.name = "Кулинария: котелок у костра"
ITEM.description = "Заляпанная жиром записная книжка с рецептами из того, что нормальный человек едой бы не назвал. Между страницами застряли крупинки соли и сухая травинка. При прочтении повышает навык «Кулинария» на +1."
...
ITEM.attributeCandidates = {"cooking", "cul", "Кулинария"}
