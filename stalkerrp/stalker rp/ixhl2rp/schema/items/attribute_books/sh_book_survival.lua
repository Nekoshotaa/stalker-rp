ITEM.name = "Выживание: три дня без костра"
ITEM.description = "Полевая книжка о том, как не умереть от холода, жажды и собственной глупости. Внутри — заметки о следах мутантов, укрытиях от ветра и воде, которую лучше не пить даже после кипячения. При прочтении повышает навык «Выживание» на +1."
...
ITEM.attributeCandidates = {"survival", "sur", "Выживание"}
