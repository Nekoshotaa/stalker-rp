ITEM.name = 'Охотничьи колбаски'
ITEM.description = 'Копчёные колбаски с ярким вкусом. Удобны в дороге и долго не портятся.'
ITEM.model = 'models/wick/wrbstalker/cop/newmodels/items/wick_sausage.mdl'

ITEM.category = "Еда"
ITEM.uniqueID = 'food_hunting_sausages'
ITEM.price = 290
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 34
