ITEM.name = 'Бутылка воды <Гуржоми>'
ITEM.description = 'Чистая минеральная вода. Самый надёжный способ утолить жажду без лишних сюрпризов.'
ITEM.model = 'models/kek1ch/dev_mineral_water.mdl'

ITEM.uniqueID = 'drink_water_gurzhomi'
ITEM.price = 190
ITEM.width = 1
ITEM.height = 2
ITEM.hunger = 0
