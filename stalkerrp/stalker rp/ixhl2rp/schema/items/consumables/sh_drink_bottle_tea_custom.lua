ITEM.name = 'Бутылка чая'
ITEM.description = 'Крепкий сладкий чай в бутылке. Хорошо идёт в холод и помогает немного прийти в себя.'
ITEM.model = 'models/kek1ch/drink_tea.mdl'

ITEM.uniqueID = 'drink_bottle_tea_custom'
ITEM.price = 240
ITEM.width = 1
ITEM.height = 2
ITEM.hunger = 0
...
ITEM.functions.Use = {
    ...
    OnRun = function(item)
        ...
        if client.AddBuff then client:AddBuff("buff_radiationremoval", 10, { amount = 0.15 }) end
