...
ITEM.name = "Стеклянный Шар"
ITEM.description = "Гладкий прозрачный шар с неестественными бликами внутри. Повышает внимательность к мелочам и деталям."
ITEM.longdesc = "Носитель начинает замечать движение, следы, слабые отблески и детали, которые обычно ускользают от взгляда. За ясность приходится платить радиацией."
ITEM.model = "models/wick/anarchycell/items/artefacts/builds/anarchycell_glass_ball.mdl"
ITEM.price = 23200
ITEM.artifactRadiation = 0.4
ITEM.attribBoosts = {
	["obs"] = 4,
}
