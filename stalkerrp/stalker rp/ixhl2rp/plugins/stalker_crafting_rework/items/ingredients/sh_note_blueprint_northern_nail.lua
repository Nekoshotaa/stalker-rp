ITEM.name = "Записка: винтовка «Северный Гвоздь»"
ITEM.description = "Потрёпанная схема самодельной винтовки. На полях много пометок про прочистку ствола, подгонку ложа и то, что стрелять лучше только после молитвы."
ITEM.model = "models/akabenko/item_notens.mdl"
ITEM.uniqueID = "note_blueprint_northern_nail"
...
ITEM.recipeID = "blueprint_northern_nail"
ITEM.recipeName = "Самодельная винтовка «Северный Гвоздь»"
