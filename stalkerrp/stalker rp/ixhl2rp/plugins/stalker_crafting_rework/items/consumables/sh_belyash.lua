ITEM.name = "Беляш"
ITEM.description = "Плотный жареный беляш с грубой мясной начинкой из тушкана. На вид простоват, но горячее тесто и жирное мясо делают его куда приятнее, чем кажется с первого укуса."
ITEM.model = "models/models/belyash.mdl"
ITEM.uniqueID = "food_belyash"
ITEM.category = "Еда"
...
function ITEM:PopulateTooltipIndividual(tooltip)
    ix.util.PropertyDesc(tooltip, "Сытная выпечка", Color(205, 170, 125))
end
