...
ix.currency.symbol = ""
ix.currency.singular = "soviet"
ix.currency.plural = "soviet"
...
ix.config.Add("walkSpeed", 110, "Скорость ходьбы игрока.", nil, {
	data = {min = 0, max = 500},
	category = "characters"
})

ix.config.Add("runSpeed", 190, "Скорость бега игрока.", nil, {
	data = {min = 0, max = 500},
	category = "characters"
})