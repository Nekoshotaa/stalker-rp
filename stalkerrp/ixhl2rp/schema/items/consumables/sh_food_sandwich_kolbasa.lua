ITEM.name = 'Бутерброд с колбасой'
ITEM.description = 'Простой, но сытный бутерброд. Отличный перекус в дороге, если не хочется открывать консервы.'
ITEM.model = 'models/dfch/irem_buterbrod.mdl'

ITEM.uniqueID = 'food_sandwich_kolbasa'
ITEM.price = 260
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 16
...
ITEM.functions.Use = {
    ...
    OnRun = function(item)
        ...
        ix.chat.Send(client, "iteminternal", "съедает свой "..item.name..".", false)
