ITEM.name = 'Консерва <Тульское>'
ITEM.description = 'Обычная мясная консерва. В Зоне такие любят за простоту, срок хранения и сытность.'
ITEM.model = 'models/kek1ch/dev_conserv.mdl'

ITEM.uniqueID = 'food_conserv_tulskoe'
ITEM.price = 430
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 20
