ITEM.name = 'Батон'
ITEM.description = 'Свежесть уже не та, но мягкий белый хлеб всё ещё остаётся простым способом заморить червячка.'
ITEM.model = 'models/wick/wrbstalker/cop/newmodels/items/wick_bread.mdl'

ITEM.uniqueID = 'food_baton'
ITEM.price = 160
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 12
