...
ITEM.name = "Кристальный цветок"
ITEM.description = "Тёплый кристаллический артефакт. Хорошо защищает от жара и немного выводит радиацию."
ITEM.longdesc = "Особенно полезен возле жарок и в долгих походах по аномальным скоплениям."
ITEM.model = "models/wick/anarchycell/items/artefacts/cop/anarchycell_cristall_flower.mdl"
ITEM.price = 8400
ITEM.burnResist = 0.45
ITEM.radRegen = 0.25
ITEM.artifactRadiation = 0.18
