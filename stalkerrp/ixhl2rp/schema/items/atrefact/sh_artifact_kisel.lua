...
ITEM.name = "Кисель"
ITEM.description = "Плотный полупрозрачный артефакт. Ослабляет набор радиации и понемногу очищает организм."
ITEM.longdesc = "Полезен в затяжных маршрутах через заражённые участки. Защищает стабильно, без резких бонусов."
ITEM.model = "models/wick/wrbstalker/shoc/items/artefacts/wick_artefact_ameba3.mdl"
ITEM.price = 6900
ITEM.flatRadProt = 0.08
ITEM.radProtPercent = 0.16
ITEM.radRegen = 0.2
ITEM.artifactRadiation = 0.08
