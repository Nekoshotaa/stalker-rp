...
ITEM.description = "Легендарный гравитационный артефакт. Облегчает прыжки и смягчает падения, но очень заметно фонит."
ITEM.longdesc = "Один из самых полезных артефактов для мобильности, но носить его без защиты опасно."
ITEM.model = "models/wick/anarchycell/items/artefacts/cop/anarchycell_gold_fish.mdl"
ITEM.price = 15400
ITEM.jumpVelocityBonus = 60
ITEM.fallResist = 0.45
ITEM.runSpeedMultBonus = 0.04
ITEM.artifactRadiation = 0.45
