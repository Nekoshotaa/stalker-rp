...
ITEM.name = "Капли Проводника"
ITEM.description = "Тяжёлые вязкие капли, будто поймавшие в себе движение самой Зоны. Носитель лучше чувствует опасные маршруты."
ITEM.longdesc = "Редкий артефакт, который словно шепчет о неверных тропах и плохих решениях. Очень полезен тем, кто привык жить на интуиции, но расплачивается за это радиацией."
ITEM.model = "models/wick/anarchycell/items/artefacts/soc/anarchycell_kaply.mdl"
ITEM.price = 24800
ITEM.artifactRadiation = 0.5
ITEM.attribBoosts = {
	["intu"] = 5,
}
