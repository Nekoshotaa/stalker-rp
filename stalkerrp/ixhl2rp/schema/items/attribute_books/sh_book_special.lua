ITEM.name = "Особое оружие: редкие системы"
ITEM.description = "Техническая подборка по странному оружию, экспериментальным образцам и механизмам, которые встречаются редко, но шумят громко. Некоторые схемы явно переписаны с чужих слов. При прочтении повышает навык «Особое оружие» на +1."
...
ITEM.attributeCandidates = {"special", "spc", "Особое оружие"}
