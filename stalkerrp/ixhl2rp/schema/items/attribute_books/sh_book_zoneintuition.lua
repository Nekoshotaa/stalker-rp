ITEM.name = "Чутьё Зоны: слушать тишину"
ITEM.description = "Странная книжка без нормальной структуры: заметки о предчувствиях, плохих местах и тишине перед выбросом. Рационального мало, но сталкеры почему-то берегут такие записи. При прочтении повышает навык «Чутьё Зоны» на +1."
...
ITEM.attributeCandidates = {"zoneintuition", "intu", "Чутьё Зоны"}
