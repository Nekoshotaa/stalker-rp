ITEM.name = "Снайперское дело: один выстрел"
ITEM.description = "Потрёпанный конспект с таблицами поправок, заметками о ветре и терпении. Последняя страница почти пустая, только фраза: «спешка громче выстрела». При прочтении повышает навык «Снайперское дело» на +1."
...
ITEM.attributeCandidates = {"sniper", "snp", "Снайперское дело"}
