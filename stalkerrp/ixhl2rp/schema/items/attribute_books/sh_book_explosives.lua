ITEM.name = "Взрывчатка: сапёрная памятка"
ITEM.description = "Пожелтевшая памятка с предупреждениями, таблицами задержек и схемами растяжек. На первой странице крупно выведено: «Если сомневаешься — не трогай». При прочтении повышает навык «Взрывчатка» на +1."
...
ITEM.attributeCandidates = {"explosives", "exp", "Взрывчатка"}
