ITEM.name = "Скрытность: не скрипеть полом"
ITEM.description = "Пособие о тихом шаге, выборе маршрута и привычке не силуэтиться на фоне неба. Между страницами вложена чёрная нитка — может, закладка, а может, напоминание. При прочтении повышает навык «Скрытность» на +1."
...
ITEM.attributeCandidates = {"stealth", "stl", "Скрытность"}
