ITEM.name = "Убеждение: мягкий нажим"
ITEM.description = "Сборник переговорных приёмов, где важны тон, пауза и правильный вопрос. Автор уверяет, что иногда одно спокойное слово экономит магазин патронов. При прочтении повышает навык «Убеждение» на +1."
...
ITEM.attributeCandidates = {"persuasion", "prs", "Убеждение"}
