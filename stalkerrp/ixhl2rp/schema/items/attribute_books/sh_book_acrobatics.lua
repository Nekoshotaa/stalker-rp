ITEM.name = "Акробатика: шаг над ржавчиной"
ITEM.description = "Старый тренировочный конспект с рисунками прыжков через проломы, трубопроводы и битый бетон. Некоторые страницы заляпаны кровью — видимо, прошлый ученик приземлялся не всегда удачно. При прочтении повышает навык «Акробатика» на +1."
...
ITEM.attributeCandidates = {"acrobatics", "acr", "Акробатика"}
