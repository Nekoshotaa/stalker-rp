ITEM.name = "Тяжёлое оружие: вес огня"
ITEM.description = "Плотный журнал о переноске, установке и контроле тяжёлых стволов. На обложке след от ожога, а на первой странице коротко: «не геройствуй без опоры». При прочтении повышает навык «Тяжёлое оружие» на +1."
...
ITEM.attributeCandidates = {"heavy", "hvy", "Тяжёлое оружие"}
