ITEM.name = "Наблюдательность: заметить лишнее"
ITEM.description = "Тихая книжка о следах, привычках людей и мелочах, которые обычно пропускают. После нескольких страниц начинаешь невольно смотреть на углы, окна и чужие руки. При прочтении повышает навык «Наблюдательность» на +1."
...
ITEM.attributeCandidates = {"observation", "obs", "Наблюдательность"}
