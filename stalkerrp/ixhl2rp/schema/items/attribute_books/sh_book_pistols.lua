ITEM.name = "Пистолеты: последний аргумент"
ITEM.description = "Карманное наставление по короткоствольному оружию: стойка, быстрый выхват, контроль дыхания и стрельба в тесных помещениях. На обложке выцарапано: «когда всё пошло плохо». При прочтении повышает навык «Пистолеты» на +1."
...
ITEM.attributeCandidates = {"pistols", "pst", "Пистолеты"}
