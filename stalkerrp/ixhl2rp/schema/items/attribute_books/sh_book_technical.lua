ITEM.name = "Технические науки: схемы и ток"
ITEM.description = "Учебная папка с фрагментами схем, формулами на полях и объяснениями, почему нельзя соединять провода «на авось». Выглядит сухо, но в умелых руках спасает оборудование и нервы. При прочтении повышает навык «Технические науки» на +1."
...
ITEM.attributeCandidates = {"technical", "tec", "Технические науки"}
