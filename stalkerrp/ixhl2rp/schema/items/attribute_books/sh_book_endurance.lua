ITEM.name = "Выносливость: марш до рассвета"
ITEM.description = "Старый армейский дневник с расписанными марш-бросками, дыханием на подъёме и советами по экономии сил. Бумага пахнет потом, сыростью и долгой дорогой. При прочтении повышает навык «Выносливость» на +1."
...
ITEM.attributeCandidates = {"endurance", "end", "Выносливость"}
