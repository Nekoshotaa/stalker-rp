ITEM.name = "Устойчивость: не дрогнуть"
ITEM.description = "Книга о самоконтроле, боли, страхе и привычке продолжать движение, когда тело просит лечь. Читать её неприятно, но в Зоне приятное редко бывает полезным. При прочтении повышает навык «Устойчивость» на +1."
...
ITEM.attributeCandidates = {"stability", "stb", "Устойчивость"}
