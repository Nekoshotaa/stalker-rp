ITEM.name = "Химия: реактивы Зоны"
ITEM.description = "Лабораторные записи с пятнами реагентов и предупреждениями на каждой второй странице. Внутри — основы растворов, фильтрации и того, почему неизвестную жидкость нельзя нюхать из любопытства. При прочтении повышает навык «Химия» на +1."
...
ITEM.attributeCandidates = {"chemistry", "chm", "Химия"}
