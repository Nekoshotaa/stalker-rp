ITEM.name = "Ближний бой: короткая дистанция"
ITEM.description = "Засаленная тетрадь с грубыми схемами ударов прикладом, ножом и голыми руками. Автор не учит красоте — только тому, как закончить драку раньше, чем противник достанет ствол. При прочтении повышает навык «Ближний бой» на +1."
...
ITEM.attributeCandidates = {"melee", "mel", "Ближний бой"}
