ITEM.name = "Пистолеты-пулемёты: плотная очередь"
ITEM.description = "Тонкий сборник о стрельбе короткими очередями, смене магазина на ходу и работе в коридорах. Автор явно любил оружие компактное, злое и быстрое. При прочтении повышает навык «Пистолеты-пулемёты» на +1."
...
ITEM.attributeCandidates = {"smg", "smg", "Пистолеты-пулемёты"}
