ITEM.name = "Упаковка бинтов"
ITEM.description = "Плотно упакованные стерильные бинты. Хорошо подходят для остановки кровотечения и обработки мелких ран."
ITEM.model = "models/wick/wrbstalker/cop/newmodels/items/wick_ipp_av3.mdl"
ITEM.price = 500
ITEM.width = 1
ITEM.height = 1
