ITEM.name = "Плоский хлеб"
ITEM.description = "Плотная лепёшка дорожного хлеба. Жёсткая, сухая, зато долго не портится."
ITEM.model = "models/weapons/disbread.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_flatbread"
ITEM.price = 25
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 16
