ITEM.name = "Листья койотового табака"
ITEM.description = "Грубые листья местного табака. Скорее привычка и способ успокоить нервы, чем настоящая еда."
ITEM.model = "models/fnv/landscape/trees/nvcoyotetobaccofruit.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_coyote_tobacco"
ITEM.price = 18
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 0
