ITEM.name = "Бутылка абсента"
ITEM.description = "Тёмная бутылка абсента. Горький напиток для артистов, безумцев и тех, кто слушает шёпот ночи."
ITEM.model = "models/bioshockinfinite/absinthebottle.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "drink_absinthe"
ITEM.price = 180
ITEM.width = 1
ITEM.height = 2
ITEM.hunger = 0
