ITEM.name = "Фляга с чистой водой"
ITEM.description = "Чистая вода в старой походной фляге. На фронтире такая вещь иногда ценнее монет."
ITEM.model = "models/fnv/clutter/food/waterpurified01.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "drink_purified_water"
ITEM.price = 35
ITEM.width = 1
ITEM.height = 2
ITEM.hunger = 0
