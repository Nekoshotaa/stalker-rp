ITEM.name = 'Сгущёнка'
ITEM.description = 'Сладкая банка сгущённого молока. Поднимает настроение и быстро насыщает.'
ITEM.model = 'models/wick/wrbstalker/cop/newmodels/items/wick_condensed_milk.mdl'

ITEM.uniqueID = 'food_condensed_milk'
ITEM.price = 300
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 15
...
ITEM.functions.Use = {
    ...
    OnRun = function(item)
        ...
        if client.AddBuff then client:AddBuff("buff_staminarestore", 10, { amount = 0.60 }) end
