ITEM.name = 'Консервированная тушёнка'
ITEM.description = 'Старая добрая тушёнка. Сытно, жирно и всегда уместно у костра или прямо на ходу.'
ITEM.model = 'models/wick/wrbstalker/anomaly/items/wick_dev_tushonka.mdl'

ITEM.uniqueID = 'food_tushonka'
ITEM.price = 470
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 22
