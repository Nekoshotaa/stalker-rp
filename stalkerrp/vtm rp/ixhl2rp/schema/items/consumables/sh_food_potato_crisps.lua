ITEM.name = "Картофельные чипсы"
ITEM.description = "Мятая пачка солёных картофельных чипсов. Быстрый перекус у костра, в седле или в задней комнате салуна."
ITEM.model = "models/fnv/clutter/junk/potatocrisps.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_potato_crisps"
ITEM.price = 25
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 10
