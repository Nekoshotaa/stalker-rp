ITEM.name = "Стандартный мед-комплект"
ITEM.description = "Обычная аптечка сталкера. Не роскошь, но в Зоне лучше такая, чем никакой."
ITEM.model = "models/wick/wrbstalker/cop/newmodels/items/wick_first_aid.mdl"
ITEM.price = 1300
ITEM.width = 1
ITEM.height = 1
...
function ITEM:PopulateTooltipIndividual(tooltip)
    ix.util.PropertyDesc(tooltip, "Среднее лечение", Color(120, 220, 120))
end
