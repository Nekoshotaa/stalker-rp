ITEM.name = "Антидот"
ITEM.description = "Универсальный препарат против большинства токсических воздействий. Может помочь после контакта с ядом или химией."
ITEM.model = "models/wick/wrbstalker/cop/newmodels/items/wick_antidot.mdl"
ITEM.price = 1600
ITEM.width = 1
ITEM.height = 1
...
function ITEM:PopulateTooltipIndividual(tooltip)
    ix.util.PropertyDesc(tooltip, "Антидот", Color(100, 220, 180))
end
...
ITEM.functions.Use = {
    ...
    OnRun = function(item)
        ...
        if client.AddBuff then
            client:AddBuff("buff_radiationremoval", 8, { amount = 0.2 })
        end
