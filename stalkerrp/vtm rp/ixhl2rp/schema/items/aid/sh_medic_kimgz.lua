ITEM.name = "Комплект КИМГЗ"
ITEM.description = "Компактный медицинский комплект быстрого реагирования. Подходит для первой помощи в полевых условиях."
ITEM.model = "models/wick/wrbstalker/cop/newmodels/items/wick_kimgz.mdl"
ITEM.price = 2400
ITEM.width = 1
ITEM.height = 1
...
function ITEM:PopulateTooltipIndividual(tooltip)
    ix.util.PropertyDesc(tooltip, "Полевая первая помощь", Color(120, 220, 120))
end
