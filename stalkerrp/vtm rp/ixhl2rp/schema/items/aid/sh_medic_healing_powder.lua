ITEM.name = 'Лечебный порошок'
ITEM.description = 'Грубый порошок из сушёных трав и кореньев. Его сыплют на раны или размешивают с водой. Помогает, но сушит горло и оставляет неприятную горечь.'
ITEM.model = 'models/fnv/clutter/healingpowder/healingpowder.mdl'
ITEM.price = 300
ITEM.width = 1
ITEM.height = 1
...
function ITEM:PopulateTooltipIndividual(tooltip)
    ix.util.PropertyDesc(tooltip, "Полевое лечение", Color(150, 220, 150))
end
...
ITEM.functions.Use = {
    ...
    OnRun = function(item)
        ...
        if client.AddBuff then
            client:AddBuff("buff_slowheal", 12, { amount = 1 })
        end
        clampNeeds(client, -2, -8)
