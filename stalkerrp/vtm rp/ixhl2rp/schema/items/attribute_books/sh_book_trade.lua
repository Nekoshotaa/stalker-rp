ITEM.name = "Торговля: цена и пауза"
ITEM.description = "Записная книжка с ценами, уловками перекупщиков и советами, когда лучше молчать, чем сбивать цену словами. Пахнет табаком и чужими деньгами. При прочтении повышает навык «Торговля» на +1."
...
ITEM.attributeCandidates = {"trade", "trd", "Торговля"}
