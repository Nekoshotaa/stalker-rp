ITEM.name = "Инженерия: ремонт на колене"
ITEM.description = "Плотная папка с чертежами креплений, самодельных фиксаторов и временных ремонтов. Некоторые решения выглядят страшно, но в Зоне «работает» часто важнее, чем «красиво». При прочтении повышает навык «Инженерия» на +1."
...
ITEM.attributeCandidates = {"engineering", "eng", "Инженерия"}
