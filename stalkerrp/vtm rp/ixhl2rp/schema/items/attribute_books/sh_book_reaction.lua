ITEM.name = "Реакция: доля секунды"
ITEM.description = "Серия упражнений на внимание, слух и быстрый ответ на движение. Текст скучный, зато после чтения хочется держать палец ближе к спуску. При прочтении повышает навык «Реакция» на +1."
...
ITEM.attributeCandidates = {"reaction", "rea", "Реакция"}
