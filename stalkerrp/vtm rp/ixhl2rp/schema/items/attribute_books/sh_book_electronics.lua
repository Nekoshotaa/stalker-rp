ITEM.name = "Электроника: пайка в темноте"
ITEM.description = "Пособие по платам, контактам, датчикам и ремонту приборов, которые давно должны были умереть. На полях нарисован детектор с подписью: «не бей, а пропаяй». При прочтении повышает навык «Электроника» на +1."
...
ITEM.attributeCandidates = {"electronics", "elc", "Электроника"}
