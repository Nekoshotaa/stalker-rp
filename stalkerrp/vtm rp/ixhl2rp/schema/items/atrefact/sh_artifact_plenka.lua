...
ITEM.name = "Плёнка"
ITEM.description = "Тонкий химический артефакт. Хорошо гасит радиационный фон и помогает организму выводить накопленное."
ITEM.longdesc = "Незаметный, но очень полезный артефакт для сталкеров, которые часто работают в заражённых низинах."
ITEM.model = "models/wick/anarchycell/items/artefacts/soc/anarchycell_plenka.mdl"
ITEM.price = 7600
ITEM.flatRadProt = 0.12
ITEM.radProtPercent = 0.12
ITEM.radRegen = 0.35
