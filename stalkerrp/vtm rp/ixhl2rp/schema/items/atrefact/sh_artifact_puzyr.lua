...
ITEM.name = "Пузырь"
ITEM.description = "Редкий артефакт с выраженным противорадиационным эффектом. Один из лучших вариантов для грязных зон."
ITEM.longdesc = "Почти не имеет собственного фона и отлично подходит для долгих походов по заражённым территориям."
ITEM.model = "models/wick/anarchycell/items/artefacts/cop/anarchycell_baloon.mdl"
ITEM.price = 11800
ITEM.flatRadProt = 0.1
ITEM.radProtPercent = 0.18
ITEM.radRegen = 0.35
