...
if (CLIENT) then
	...
	function ENT:OnPopulateEntityInfo(container)
		...
		name:SetImportant()
		name:SetText("Поломанный кейс")
		name:SizeToContents()

		local description = container:AddRow("description")
		description:SetText("Тяжёлый старый кейс. Часто в таких лежит медицина, техничка или полезные расходники.")
