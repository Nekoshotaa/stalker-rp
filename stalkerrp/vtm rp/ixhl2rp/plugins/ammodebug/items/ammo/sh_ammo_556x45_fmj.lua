ITEM.name = "5.56x45 мм FMJ"
ITEM.description = "Коробка автоматных патронов 5.56x45 FMJ. Подходит для M16A2, LR-300ML и другого оружия с тем же ammo type."
ITEM.base = "base_ammo"
ITEM.model = "models/kek1ch/ammo_556x45_ap.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.category = "Ammo"
ITEM.ammoType = "ammo_556x45_fmj"
ITEM.ammoAmount = 60
ITEM.ammoBoxText = "Стандартные патроны 5.56x45."
