ITEM.name = "7.62x39 мм FMJ"
ITEM.description = "Коробка винтовочных патронов 7.62x39 FMJ. Подходит для Тип 63 и другого оружия под этот калибр."
ITEM.base = "base_ammo"
ITEM.model = "models/kek1ch/ammo_762x39_fmj.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.category = "Ammo"
ITEM.ammoType = "ammo_762x39_fmj"
ITEM.ammoAmount = 40
ITEM.ammoBoxText = "Стандартные винтовочные патроны 7.62x39."
