ITEM.name = "Фасоль со свининой"
ITEM.description = "Жестяная банка фасоли со свининой. Простая, тяжёлая и честная еда фронтира: согревает желудок лучше любых обещаний."
ITEM.model = "models/fnv/clutter/junk/porknbeans.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_pork_beans"
ITEM.price = 45
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 24
