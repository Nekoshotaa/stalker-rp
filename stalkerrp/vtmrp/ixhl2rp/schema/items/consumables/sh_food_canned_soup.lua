ITEM.name = "Банка томатного супа"
ITEM.description = "Открытая банка густого томатного супа. Пахнет металлом, солью и старым складом."
ITEM.model = "models/bioshockinfinite/canned_soup.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_canned_soup"
ITEM.price = 55
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 20
