ITEM.name = "Коробка пшеничной каши"
ITEM.description = "Коробка сухой пшеничной каши. Завтрак цивилизации, занесённый пылью на край света."
ITEM.model = "models/bioshockinfinite/loot_cereal_box_cornflakes.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_wheat_cereal"
ITEM.price = 38
ITEM.width = 1
ITEM.height = 2
ITEM.hunger = 18
