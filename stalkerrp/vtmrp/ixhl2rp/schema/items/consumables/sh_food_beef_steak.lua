ITEM.name = "Говяжий стейк"
ITEM.description = "Толстый кусок мяса, прожаренный на открытом огне. Хорошая еда для тех, кто ещё способен наслаждаться обычной пищей."
ITEM.model = "models/fnv/clutter/food/steak01.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_beef_steak"
ITEM.price = 85
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 36
