ITEM.name = "Бутылка вермута"
ITEM.description = "Бутылка сладковатого вермута. Не самый грубый напиток фронтира, но в нужных руках тоже оружие."
ITEM.model = "models/bioshockinfinite/vermouth_bottle.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "drink_vermouth"
ITEM.price = 110
ITEM.width = 1
ITEM.height = 2
ITEM.hunger = 0
