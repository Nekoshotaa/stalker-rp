ITEM.name = "Сухой мясной рацион"
ITEM.description = "Плоская упаковка мясного рациона. Не роскошь, но выручает в долгой дороге и во время ночной засады."
ITEM.model = "models/fnv/clutter/junk/cram01.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_cram"
ITEM.price = 50
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 22
