ITEM.name = "Жареный стейк пустоши"
ITEM.description = "Кусок прожаренного мяса. Вид у него сомнительный, но на дороге не принято задавать слишком много вопросов."
ITEM.model = "models/fnv/clutter/food/nvgeckosteak.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_gecko_steak"
ITEM.price = 70
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 30
