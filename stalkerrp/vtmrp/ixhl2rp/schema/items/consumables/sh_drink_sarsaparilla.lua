ITEM.name = "Бутылка сарсапариллы"
ITEM.description = "Сладкая газировка в стеклянной бутылке. Любимый напиток тех, кто ещё делает вид, будто ночь не изменила их жизнь."
ITEM.model = "models/fnv/clutter/junk/ssbottle01.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "drink_sarsaparilla"
ITEM.price = 30
ITEM.width = 1
ITEM.height = 2
ITEM.hunger = 2
