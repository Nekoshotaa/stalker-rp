ITEM.name = "Початок кукурузы"
ITEM.description = "Суховатый початок кукурузы. Простая еда фермеров, караванщиков и тех, кто не ждёт лучшего."
ITEM.model = "models/fnv/landscape/plants/maize_healthypdrop.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "food_corn_cob"
ITEM.price = 20
ITEM.width = 1
ITEM.height = 1
ITEM.hunger = 12
