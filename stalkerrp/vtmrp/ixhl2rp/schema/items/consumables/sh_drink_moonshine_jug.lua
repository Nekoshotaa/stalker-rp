ITEM.name = "Кувшин самогона"
ITEM.description = "Грубый кувшин с крепким самогоном. Пахнет кукурузой, дымом и плохими решениями."
ITEM.model = "models/fnv/dlc04/clutter/moonshine/dlc04moonshinejug01.mdl"

ITEM.category = "Еда и напитки"
ITEM.uniqueID = "drink_moonshine_jug"
ITEM.price = 140
ITEM.width = 2
ITEM.height = 2
ITEM.hunger = 0
