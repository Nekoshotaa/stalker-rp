ITEM.name = 'Сумка доктора'
ITEM.description = 'Потрёпанная кожаная сумка с бинтами, иглами, спиртом и инструментами. В хороших руках спасает жизнь, в плохих — только оттягивает конец.'
ITEM.model = 'models/fnv/clutter/health/doctorbag.mdl'
ITEM.price = 1200
ITEM.width = 1
ITEM.height = 1
...
function ITEM:PopulateTooltipIndividual(tooltip)
    ix.util.PropertyDesc(tooltip, "Медицинский набор", Color(120, 220, 120))
end
...
ITEM.functions.Use = {
    ...
    OnRun = function(item)
        ...
        if client.AddBuff then
            client:AddBuff("buff_slowheal", 15, { amount = 1 })
        end
