...
ITEM.name = "Электра-Сердечник"
ITEM.description = "Пульсирующий электрический артефакт. Мысли о схемах и питании рядом с ним становятся удивительно ясными."
ITEM.longdesc = "Почти живой сгусток электрической аномалии. Идеален для технарей и мастеров полевой электроники, но сам по себе остаётся радиоактивной дрянью."
ITEM.model = "models/wick/wrbstalker/shoc/items/artefacts/wick_artefact_electra1.mdl"
ITEM.price = 25700
ITEM.artifactRadiation = 0.52
ITEM.attribBoosts = {
	["elc"] = 5,
}
