...
ITEM.name = "Вспышка"
ITEM.description = "Электрический артефакт с ярким свечением. Отлично гасит шок и слегка ускоряет носителя, но фонит."
ITEM.longdesc = "Хороший спутник в электрах и на быстрых вылазках."
ITEM.model = "models/wick/anarchycell/items/artefacts/cop/anarchycell_flash.mdl"
ITEM.price = 8900
ITEM.shockResist = 0.6
ITEM.runSpeedMultBonus = 0.03
ITEM.artifactRadiation = 0.22
